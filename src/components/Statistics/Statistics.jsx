            ...
            <section className='flex gap-[20%]'>
                <div className='chart'>
                    ...
                    >
                        ...
                        <Tooltip />
                        <Legend />
                        <Bar dataKey="Marks" barSize={20} fill="#000000" />
                    </ComposedChart>
                </div>
                <div>
                    <ol className=''>
                        <li className='color1'>Assignment-57</li>
                        <li className='color2'>Assignment-57</li>
                        <li className='color3'>Assignment-60</li>
                        <li className='color4'>Assignment-38</li>
                        <li className='color5'>Assignment-60</li>
